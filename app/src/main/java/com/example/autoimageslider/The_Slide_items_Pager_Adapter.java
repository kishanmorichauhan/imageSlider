...
public class The_Slide_items_Pager_Adapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        TextView caption_description = sliderLayout.findViewById(R.id.my_description);
        ...
        caption_description.setText(theSlideItemsModelClassList.get(position).getThe_caption_descri());
